...
RepositoryDetailState _$RepositoryDetailStateFromJson(
    Map<String, dynamic> json) {
  return _RepositoryDetailState.fromJson(json);
}
...
class _$RepositoryDetailStateImpl implements _RepositoryDetailState {
  ...
  @override
  String toString() {
    return 'RepositoryDetailState(id: $id, repositoryName: $repositoryName, ownerName: $ownerName, ownerImageUri: $ownerImageUri, starCount: $starCount, watcherCount: $watcherCount, forksCount: $forksCount, language: $language, description: $description, repositoryUrl: $repositoryUrl, upDateAt: $upDateAt)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$RepositoryDetailStateImplToJson(
      this,
    );
  }
}
...
abstract class _RepositoryDetailState implements RepositoryDetailState {
  const factory _RepositoryDetailState(
      ...
      required final String upDateAt}) = _$RepositoryDetailStateImpl;
